...
class UserSettings(Base):
    ...
    source_lang = Column(String(10), default="auto", nullable=False)
    target_lang = Column(String(10), default="uz", nullable=False)
    interface_lang = Column(String(10), default="uz", nullable=False)

    tts_enabled = Column(Boolean, default=True, nullable=False)
    tts_auto = Column(Boolean, default=False, nullable=False)
    ...
    allow_training = Column(Boolean, default=True, nullable=False, index=True)
...
class Language(Base):
    ...
    supports_tts = Column(Boolean, default=False, nullable=False)
    supports_detection = Column(Boolean, default=True, nullable=False)
    tts_voice = Column(String(64))
...
class Translation(Base):
    ...
    chat_type = Column(String(20), default="private", nullable=False)
    input_kind = Column(String(20), default="text", nullable=False)

    source_lang_requested = Column(String(10), default="auto", nullable=False)
    ...
    target_chars = Column(Integer, default=0, nullable=False)
...
class Event(Base):
    ...
    source = Column(String(20), default="bot", nullable=False)
...
class DailyUsage(Base):
    ...
    tts_count = Column(Integer, default=0, nullable=False)
